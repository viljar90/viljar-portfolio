...
const ProjectCard = ({ project }) => {
  return (
    <div className="w-full max-w-md md:max-w-lg bg-bg-base rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out overflow-hidden hover:scale-105 dark:border dark:border-gray-700">
